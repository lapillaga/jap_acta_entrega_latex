...
% Secciones
\input{sections/01_informe_gestion}
\clearpage

\input{sections/02_informe_economico}
\clearpage

\input{sections/03_inventario}
\clearpage

\input{sections/04_planos_croquis}
\clearpage

\input{sections/05_catastro_y_nuevos_socios}
\clearpage

\input{sections/06_correspondencia_relevante}
\clearpage

\input{sections/07_contratos_convenios_contactos}
\clearpage

\input{sections/08_accesos_credenciales}
\clearpage

\input{sections/09_acta_entrega_recepcion}
\clearpage
